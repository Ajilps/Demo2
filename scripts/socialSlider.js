class CustomSlider {
  constructor(container) {
    ...
    this.slides = container.querySelectorAll(".social-slide");
  ...
  createPagination() {
    const pagination = this.container.querySelector(".social-pagination");
    for (let i = 0; i < this.totalSlides; i++) {
      const dot = document.createElement("div");
      dot.classList.add("social-pagination-dot");
  ...
  updateSlides() {
    ...
    // Update pagination
    const dots = this.container.querySelectorAll(".social-pagination-dot");
